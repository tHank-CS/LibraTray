...
| NumberOneBot/yeelight-client | <https://github.com/NumberOneBot/yeelight-client> | MIT | current `lamp15` dual-channel/notification leads; segment command lead remains unverified | No | protocol behavior lead only |
