...
Report abusive, harassing, or otherwise unacceptable behavior through a private
maintainer contact published by the repository. If no private address is
published yet, open a minimal issue requesting private contact without
including sensitive details. All complaints will be reviewed promptly and
fairly. Community leaders must respect the privacy and security of reporters.

## Enforcement guidelines

Community leaders will use these guidelines:
...
3. **Temporary ban** — A temporary ban from interaction or public
   communication with the community.
4. **Permanent ban** — Permanent removal from community interaction.

The response will be proportionate to impact, intent, and pattern of behavior.
